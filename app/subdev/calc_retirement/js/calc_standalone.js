 		...
 		require('./formula_standalone.js');
		  module.exports = {
            unitTest : function(data){
					me.data = data;
				me.tempValues = {
		...
		/*me.data = {
			...
			spouse : true,
			currentAgePrimary	: 39, 						//B4
			currentAgeSecondary	: 38, 						//C4
			retirementStartAgePrimary :65, 					//B5
			retirementStartAgeSecondary	:65, 				//C5
			yearInRetirementPrimary : 15, 					//B6
			yearInRetirementSecondary : 14, 				//C6
			annualIncomePrimary : 65000, 					//B7
			annualIncomeSecondary : 80000, 				//C7
			targetRetirementIncomePrimaryAmount : 35000, 	//B8
			targetRetirementIncomeSecondaryAmount : 0, 		//C8
			targetRetirementIncomePrimaryPercent : 0, 		//B9 
			targetRetirementIncomeSecondaryPercent : 0.5, 	//C9
		...
		function calculateResults()
		{
			...
			me.results.npvDesiredIncomePrimary = Formula.MAX((-1)*me.tempValues.sumSprimary,0);
			me.results.pvOfInvestmentRequiredPrimary = Formula.MAX(Formula.PV(me.tempValues.realInterestRate,me.data.retirementStartAgePrimary-me.data.currentAgePrimary,me.tempValues.inputB21+me.tempValues.inputB24+me.tempValues.inputB27,(-1)*me.results.npvDesiredIncomePrimary,1),0);
